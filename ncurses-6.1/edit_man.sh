...
TERMINFO="/home/cc/ee147/fl21/class/ee147-aaf/software/python/1/share/terminfo"
...
if test "$form" = normal ; then
	if test "no" = yes ; then
	if test "no" = no ; then
		/usr/bin/ksh $0 format $verb $mandir $srcdir $*
		exit 0
	fi
	fi
...
(*.[0-9]*)
	...
	if test ! -f /home/cc/ee147/fl21/class/ee147-aaf/software/ncurses-6.1/man_alias.sed ; then
cat >>/home/cc/ee147/fl21/class/ee147-aaf/software/ncurses-6.1/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/cc/ee147/fl21/class/ee147-aaf/software/ncurses-6.1/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/cc/ee147/fl21/class/ee147-aaf/software/ncurses-6.1/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	...
	sed	-f /home/cc/ee147/fl21/class/ee147-aaf/software/ncurses-6.1/man_alias.sed \
		< $i >$TMP
