...
NCURSES_EXPORT(int) (addch) (const chtype z)
{
	...
	returnCode(waddch(_nc_stdscr(),(z)));
}
...
NCURSES_EXPORT(int) (addchnstr) (const chtype * a1, int z)
{
	...
	returnCode(waddchnstr(_nc_stdscr(),(a1),(z)));
}
...
NCURSES_EXPORT(int) (addchstr) (const chtype * z)
{
	...
	returnCode(waddchnstr(_nc_stdscr(),(z),-1));
}
...
NCURSES_EXPORT(int) (addnstr) (const char * a1, int z)
{
	...
	returnCode(waddnstr(_nc_stdscr(),(a1),(z)));
}
...
NCURSES_EXPORT(int) (addstr) (const char * z)
{
	...
	returnCode(waddnstr(_nc_stdscr(),(z),-1));
}
...
NCURSES_EXPORT(int) (attroff) (int z)
{
	...
	returnCode(wattr_off(_nc_stdscr(), (attr_t)((z)), ((void *)0)));
}
...
NCURSES_EXPORT(int) (attron) (int z)
{
	...
	returnCode(wattr_on(_nc_stdscr(), (attr_t)((z)), ((void *)0)));
}
...
NCURSES_EXPORT(int) (attrset) (int z)
{
	...
	returnIntAttr((attr_t)((0 != (const void *)((_nc_stdscr()))) ? ((_nc_stdscr())->_color = (int)(((int)((((unsigned long)(((z))) & ((chtype)((((1U) << 8) - 1U)) << ((0) + 8))) >> 8)))), (_nc_stdscr())->_attrs = (attr_t)((z)), (0)) : (-1)));
}
...
NCURSES_EXPORT(int) (attr_get) (attr_t * a1, short * a2, void * z GCC_UNUSED)
{
	...
	returnCode(((0 != (const void *)((_nc_stdscr()))) ? ((void)((0 != (const void *)(((a1)))) ? (*((a1)) = (_nc_stdscr())->_attrs) : (0)), (void)((0 != (const void *)(((a2)))) ? (*((a2)) = (short) (_nc_stdscr())->_color) : (0)), (void)((0 != (const void *)(((z)))) ? (*(int *)((z)) = (_nc_stdscr())->_color) : (0)), (0)) : (-1)));
}
...
NCURSES_EXPORT(int) (attr_off) (attr_t a1, void * z)
{
	...
	returnCode(wattr_off(_nc_stdscr(),(a1),(z)));
}
...
NCURSES_EXPORT(int) (attr_on) (attr_t a1, void * z)
{
	...
	returnCode(wattr_on(_nc_stdscr(),(a1),(z)));
}
...
NCURSES_EXPORT(int) (attr_set) (attr_t a1, short a2, void * z GCC_UNUSED)
{
	...
	returnCode(((0 != (const void *)((_nc_stdscr()))) ? ((void)((_nc_stdscr())->_attrs = (((a1)) & ~((chtype)((((1U) << 8) - 1U)) << ((0) + 8))), (_nc_stdscr())->_color = ((z)) ? *(int *)((z)) : ((a2))), (0)) : (-1)));
}
...
NCURSES_EXPORT(int) (border) (chtype a1, chtype a2, chtype a3, chtype a4, chtype a5, chtype a6, chtype a7, chtype z)
{
	...
	returnCode(wborder(_nc_stdscr(), a1, a2, a3, a4, a5, a6, a7, z));
}
...
NCURSES_EXPORT(int) (chgat) (int a1, attr_t a2, short a3, const void * z)
{
	...
	returnCode(wchgat(_nc_stdscr(),(a1),(a2),(a3),(z)));
}
...
{
	T((T_CALLED("clrtobot()")));
	returnCode(wclrtobot(_nc_stdscr()));
}
...
{
	T((T_CALLED("clrtoeol()")));
	returnCode(wclrtoeol(_nc_stdscr()));
}
...
NCURSES_EXPORT(int) (color_set) (short a1, void * z)
{
	...
	returnCode(wcolor_set(_nc_stdscr(),(a1),(z)));
}
...
{
	T((T_CALLED("deleteln()")));
	returnCode(winsdelln(_nc_stdscr(),-1));
}
...
NCURSES_EXPORT(int) (echochar) (const chtype z)
{
	...
	returnCode(wechochar(_nc_stdscr(),(z)));
}
...
NCURSES_EXPORT(int) (getnstr) (char * a1, int z)
{
	...
	returnCode(wgetnstr(_nc_stdscr(), a1, (z)));
}
...
NCURSES_EXPORT(int) (getstr) (char * z)
{
	...
	returnCode(wgetnstr(_nc_stdscr(), (z), -1));
}
...
NCURSES_EXPORT(int) (hline) (chtype a1, int z)
{
	...
	returnCode(whline(_nc_stdscr(), a1, (z)));
}
...
NCURSES_EXPORT(int) (inchnstr) (chtype * a1, int z)
{
	...
	returnCode(winchnstr(_nc_stdscr(),(a1),(z)));
}
...
NCURSES_EXPORT(int) (inchstr) (chtype * z)
{
	...
	returnCode(winchnstr(_nc_stdscr(), (z), -1));
}


NCURSES_EXPORT(int) (innstr) (char * a1, int z)
{
	return winnstr(_nc_stdscr(),(a1),(z)) ;
}
...
NCURSES_EXPORT(int) (insch) (chtype z)
{
	...
	returnCode(winsch(_nc_stdscr(),(z)));
}
...
NCURSES_EXPORT(int) (insdelln) (int z)
{
	...
	returnCode(winsdelln(_nc_stdscr(),(z)));
}
...
NCURSES_EXPORT(int) (insnstr) (const char * a1, int z)
{
	...
	returnCode(winsnstr(_nc_stdscr(),(a1),(z)));
}
...
NCURSES_EXPORT(int) (insstr) (const char * z)
{
	...
	returnCode(winsnstr(_nc_stdscr(), (z), -1));
}
...
NCURSES_EXPORT(int) (instr) (char * z)
{
	...
	returnCode(winnstr(_nc_stdscr(), (z), -1));
}
...
NCURSES_EXPORT(int) (move) (int a1, int z)
{
	...
	returnCode(wmove(_nc_stdscr(),(a1),(z)));
}
...
NCURSES_EXPORT(int) (mvaddch) (int a1, int a2, const chtype z)
{
	...
	returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : waddch((_nc_stdscr()),((z)))));
}
...
NCURSES_EXPORT(int) (mvaddchnstr) (int a1, int a2, const chtype * a3, int z)
{
	...
	returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : waddchnstr((_nc_stdscr()),((a3)),((z)))));
}
...
NCURSES_EXPORT(int) (mvaddchstr) (int a1, int a2, const chtype * z)
{
	...
	returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : waddchnstr((_nc_stdscr()),((z)),-1)));
}
...
NCURSES_EXPORT(int) (mvaddnstr) (int a1, int a2, const char * a3, int z)
{
	...
	returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : waddnstr((_nc_stdscr()),((a3)),((z)))));
}
...
NCURSES_EXPORT(int) (mvaddstr) (int a1, int a2, const char * z)
{
	...
	returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : waddnstr((_nc_stdscr()),((z)),-1)));
}
...
NCURSES_EXPORT(int) (mvchgat) (int a1, int a2, int a3, attr_t a4, short a5, const void * z)
{
	...
	returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : wchgat((_nc_stdscr()),((a3)),((a4)),((a5)),((z)))));
}
...
NCURSES_EXPORT(int) (mvdelch) (int a1, int z)
{
	...
	returnCode((wmove((_nc_stdscr()),((a1)),((z))) == (-1) ? (-1) : wdelch(_nc_stdscr())));
}
...
NCURSES_EXPORT(int) (mvgetch) (int a1, int z)
{
	...
	returnCode((wmove((_nc_stdscr()),((a1)),((z))) == (-1) ? (-1) : wgetch(_nc_stdscr())));
}
...
NCURSES_EXPORT(int) (mvgetnstr) (int a1, int a2, char * a3, int z)
{
	...
	returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : wgetnstr((_nc_stdscr()),((a3)),((z)))));
}
...
NCURSES_EXPORT(int) (mvgetstr) (int a1, int a2, char * z)
{
	...
	returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : wgetnstr((_nc_stdscr()), ((z)), -1)));
}
...
NCURSES_EXPORT(int) (mvhline) (int a1, int a2, chtype a3, int z)
{
	...
	returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : whline((_nc_stdscr()),((a3)),((z)))));
}
...
NCURSES_EXPORT(chtype) (mvinch) (int a1, int z)
{
	...
	returnChtype((wmove((_nc_stdscr()),((a1)),((z))) == (-1) ? (chtype)((-1)) : winch(_nc_stdscr())));
}
...
NCURSES_EXPORT(int) (mvinchnstr) (int a1, int a2, chtype * a3, int z)
{
	...
	returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : winchnstr((_nc_stdscr()),((a3)),((z)))));
}
...
NCURSES_EXPORT(int) (mvinchstr) (int a1, int a2, chtype * z)
{
	...
	returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : winchnstr((_nc_stdscr()), ((z)), -1)));
}


NCURSES_EXPORT(int) (mvinnstr) (int a1, int a2, char * a3, int z)
{
	return (wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : winnstr((_nc_stdscr()),((a3)),((z)))) ;
}
...
NCURSES_EXPORT(int) (mvinsch) (int a1, int a2, chtype z)
{
	...
	returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : winsch((_nc_stdscr()),((z)))));
}
...
NCURSES_EXPORT(int) (mvinsnstr) (int a1, int a2, const char * a3, int z)
{
	...
	returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : winsnstr((_nc_stdscr()),((a3)),((z)))));
}
...
NCURSES_EXPORT(int) (mvinsstr) (int a1, int a2, const char * z)
{
	...
	returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : winsnstr((_nc_stdscr()), ((z)), -1)));
}
...
NCURSES_EXPORT(int) (mvinstr) (int a1, int a2, char * z)
{
	...
	returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : winnstr((_nc_stdscr()), ((z)), -1)));
}
...
NCURSES_EXPORT(int) (mvvline) (int a1, int a2, chtype a3, int z)
{
	...
	returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : wvline((_nc_stdscr()),((a3)),((z)))));
}
...
{
	T((T_CALLED("refresh()")));
	returnCode(wrefresh(_nc_stdscr()));
}
...
NCURSES_EXPORT(int) (setscrreg) (int a1, int z)
{
	...
	returnCode(wsetscrreg(_nc_stdscr(),(a1),(z)));
}
...
{
	T((T_CALLED("standout()")));
	returnIntAttr((attr_t)(((0 != (const void *)((_nc_stdscr()))) ? ((_nc_stdscr())->_color = (int)(((int)((((unsigned long)((((chtype)((1U)) << ((8) + 8)))) & ((chtype)((((1U) << 8) - 1U)) << ((0) + 8))) >> 8)))), (_nc_stdscr())->_attrs = (attr_t)(((chtype)((1U)) << ((8) + 8))), (0)) : (-1))));
}
...
{
	T((T_CALLED("standend()")));
	returnIntAttr((attr_t)(((0 != (const void *)((_nc_stdscr()))) ? ((_nc_stdscr())->_color = (int)(((int)((((unsigned long)(((1U - 1U))) & ((chtype)((((1U) << 8) - 1U)) << ((0) + 8))) >> 8)))), (_nc_stdscr())->_attrs = (attr_t)((1U - 1U)), (0)) : (-1))));
}
...
NCURSES_EXPORT(int) (vline) (chtype a1, int z)
{
	...
	returnCode(wvline(_nc_stdscr(), a1, (z)));
}
...
NCURSES_EXPORT(int) (add_wch) (const cchar_t * z)
{
	...
	returnCode(wadd_wch(_nc_stdscr(),(z)));
}
#endif
...
NCURSES_EXPORT(int) (add_wchnstr) (const cchar_t * a1, int z)
{
	...
	returnCode(wadd_wchnstr(_nc_stdscr(),(a1),(z)));
}
#endif
...
NCURSES_EXPORT(int) (add_wchstr) (const cchar_t * z)
{
	...
	returnCode(wadd_wchnstr((_nc_stdscr()),((z)),-1));
}
#endif
...
NCURSES_EXPORT(int) (addnwstr) (const wchar_t * a1, int z)
{
	...
	returnCode(waddnwstr(_nc_stdscr(),(a1),(z)));
}
#endif
...
NCURSES_EXPORT(int) (addwstr) (const wchar_t * z)
{
	...
	returnCode(waddnwstr((_nc_stdscr()),((z)),-1));
}
#endif
...
NCURSES_EXPORT(int) (bkgrnd) (const cchar_t * z)
{
	...
	returnCode(wbkgrnd(_nc_stdscr(),(z)));
}
#endif
...
NCURSES_EXPORT(int) (border_set) (const cchar_t * a1, const cchar_t * a2, const cchar_t * a3, const cchar_t * a4, const cchar_t * a5, const cchar_t * a6, const cchar_t * a7, const cchar_t * z)
{
	...
	returnCode(wborder_set(_nc_stdscr(),(a1),(a2),(a3),(a4),a5,a6,a7,z));
}
#endif
...
NCURSES_EXPORT(int) (echo_wchar) (const cchar_t * z)
{
	...
	returnCode(wecho_wchar(_nc_stdscr(),(z)));
}
#endif
...
NCURSES_EXPORT(int) (get_wch) (wint_t * z)
{
	...
	returnCode(wget_wch(_nc_stdscr(),(z)));
}
#endif
...
NCURSES_EXPORT(int) (get_wstr) (wint_t * z)
{
	...
	returnCode(wgetn_wstr((_nc_stdscr()),((z)),-1));
}
#endif
...
NCURSES_EXPORT(int) (getbkgrnd) (cchar_t * z)
{
	...
	returnCode(((0 != (const void *)(((z)))) ? ((_nc_stdscr()) ? (*((z)) = (_nc_stdscr())->_bkgrnd) : *((z)), (0)) : (-1)));
}
#endif
...
NCURSES_EXPORT(int) (getn_wstr) (wint_t * a1, int z)
{
	...
	returnCode(wgetn_wstr(_nc_stdscr(),(a1),(z)));
}
#endif
...
NCURSES_EXPORT(int) (hline_set) (const cchar_t * a1, int z)
{
	...
	returnCode(whline_set(_nc_stdscr(),(a1),(z)));
}
#endif
...
NCURSES_EXPORT(int) (in_wch) (cchar_t * z)
{
	...
	returnCode(win_wch(_nc_stdscr(),(z)));
}
#endif
...
NCURSES_EXPORT(int) (in_wchnstr) (cchar_t * a1, int z)
{
	...
	returnCode(win_wchnstr(_nc_stdscr(),(a1),(z)));
}
#endif
...
NCURSES_EXPORT(int) (in_wchstr) (cchar_t * z)
{
	...
	returnCode(win_wchnstr((_nc_stdscr()),((z)),-1));
}
#endif
...
{
	return winnwstr(_nc_stdscr(),(a1),(z)) ;
}
#endif
...
NCURSES_EXPORT(int) (ins_nwstr) (const wchar_t * a1, int z)
{
	...
	returnCode(wins_nwstr(_nc_stdscr(),(a1),(z)));
}
#endif
...
NCURSES_EXPORT(int) (ins_wch) (const cchar_t * z)
{
	...
	returnCode(wins_wch(_nc_stdscr(),(z)));
}
#endif
...
NCURSES_EXPORT(int) (ins_wstr) (const wchar_t * z)
{
	...
	returnCode(wins_nwstr((_nc_stdscr()),((z)),-1));
}
#endif
...
NCURSES_EXPORT(int) (inwstr) (wchar_t * z)
{
	...
	returnCode(winwstr(_nc_stdscr(),(z)));
}
#endif
...
NCURSES_EXPORT(int) (mvadd_wch) (int a1, int a2, const cchar_t * z)
{
	...
	returnCode((wmove(_nc_stdscr(),((a1)),((a2))) == (-1) ? (-1) : wadd_wch((_nc_stdscr()),((z)))));
}
#endif
...
NCURSES_EXPORT(int) (mvadd_wchnstr) (int a1, int a2, const cchar_t * a3, int z)
{
	...
	returnCode((wmove(_nc_stdscr(),((a1)),((a2))) == (-1) ? (-1) : wadd_wchnstr((_nc_stdscr()),((a3)),((z)))));
}
#endif
...
NCURSES_EXPORT(int) (mvadd_wchstr) (int a1, int a2, const cchar_t * z)
{
	...
	returnCode((wmove(_nc_stdscr(),((a1)),((a2))) == (-1) ? (-1) : wadd_wchnstr(((_nc_stdscr())),(((z))),-1)));
}
#endif
...
NCURSES_EXPORT(int) (mvaddnwstr) (int a1, int a2, const wchar_t * a3, int z)
{
	...
	returnCode((wmove(_nc_stdscr(),((a1)),((a2))) == (-1) ? (-1) : waddnwstr((_nc_stdscr()),((a3)),((z)))));
}
#endif
...
NCURSES_EXPORT(int) (mvaddwstr) (int a1, int a2, const wchar_t * z)
{
	...
	returnCode((wmove(_nc_stdscr(),((a1)),((a2))) == (-1) ? (-1) : waddnwstr(((_nc_stdscr())),(((z))),-1)));
}
#endif
...
NCURSES_EXPORT(int) (mvget_wch) (int a1, int a2, wint_t * z)
{
	...
	returnCode((wmove(_nc_stdscr(),((a1)),((a2))) == (-1) ? (-1) : wget_wch((_nc_stdscr()),((z)))));
}
#endif
...
NCURSES_EXPORT(int) (mvget_wstr) (int a1, int a2, wint_t * z)
{
	...
	returnCode((wmove(_nc_stdscr(),((a1)),((a2))) == (-1) ? (-1) : wgetn_wstr(((_nc_stdscr())),(((z))),-1)));
}
#endif
...
NCURSES_EXPORT(int) (mvgetn_wstr) (int a1, int a2, wint_t * a3, int z)
{
	...
	returnCode((wmove(_nc_stdscr(),((a1)),((a2))) == (-1) ? (-1) : wgetn_wstr((_nc_stdscr()),((a3)),((z)))));
}
#endif
...
NCURSES_EXPORT(int) (mvhline_set) (int a1, int a2, const cchar_t * a3, int z)
{
	...
	returnCode((wmove(_nc_stdscr(),((a1)),((a2))) == (-1) ? (-1) : whline_set((_nc_stdscr()),((a3)),((z)))));
}
#endif
...
NCURSES_EXPORT(int) (mvin_wch) (int a1, int a2, cchar_t * z)
{
	...
	returnCode((wmove(_nc_stdscr(),((a1)),((a2))) == (-1) ? (-1) : win_wch((_nc_stdscr()),((z)))));
}
#endif
...
NCURSES_EXPORT(int) (mvin_wchnstr) (int a1, int a2, cchar_t * a3, int z)
{
	...
	returnCode((wmove(_nc_stdscr(),((a1)),((a2))) == (-1) ? (-1) : win_wchnstr((_nc_stdscr()),((a3)),((z)))));
}
#endif
...
NCURSES_EXPORT(int) (mvin_wchstr) (int a1, int a2, cchar_t * z)
{
	...
	returnCode((wmove(_nc_stdscr(),((a1)),((a2))) == (-1) ? (-1) : win_wchnstr(((_nc_stdscr())),(((z))),-1)));
}
#endif
...
{
	return (wmove(_nc_stdscr(),((a1)),((a2))) == (-1) ? (-1) : winnwstr((_nc_stdscr()),((a3)),((z)))) ;
}
#endif
...
NCURSES_EXPORT(int) (mvins_nwstr) (int a1, int a2, const wchar_t * a3, int z)
{
	...
	returnCode((wmove(_nc_stdscr(),((a1)),((a2))) == (-1) ? (-1) : wins_nwstr((_nc_stdscr()),((a3)),((z)))));
}
#endif
...
NCURSES_EXPORT(int) (mvins_wch) (int a1, int a2, const cchar_t * z)
{
	...
	returnCode((wmove(_nc_stdscr(),((a1)),((a2))) == (-1) ? (-1) : wins_wch((_nc_stdscr()),((z)))));
}
#endif
...
NCURSES_EXPORT(int) (mvins_wstr) (int a1, int a2, const wchar_t * z)
{
	...
	returnCode((wmove(_nc_stdscr(),((a1)),((a2))) == (-1) ? (-1) : wins_nwstr(((_nc_stdscr())),(((z))),-1)));
}
#endif
...
NCURSES_EXPORT(int) (mvinwstr) (int a1, int a2, wchar_t * z)
{
	...
	returnCode((wmove(_nc_stdscr(),((a1)),((a2))) == (-1) ? (-1) : winwstr((_nc_stdscr()),((z)))));
}
#endif
...
NCURSES_EXPORT(int) (mvvline_set) (int a1, int a2, const cchar_t * a3, int z)
{
	...
	returnCode((wmove(_nc_stdscr(),((a1)),((a2))) == (-1) ? (-1) : wvline_set((_nc_stdscr()),((a3)),((z)))));
}
#endif
...
NCURSES_EXPORT(int) (vline_set) (const cchar_t * a1, int z)
{
	...
	returnCode(wvline_set(_nc_stdscr(),(a1),(z)));
}
#endif
...
NCURSES_EXPORT(NCURSES_BOOL) (mouse_trafo) (int * a1, int * a2, NCURSES_BOOL z)
{
	...
	returnBool(wmouse_trafo(_nc_stdscr(),a1,a2,z));
}
