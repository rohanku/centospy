...
our %config = (
  ...
  openssldir => "/home/cc/ee147/fl21/class/ee147-aaf/software/openssl-1.1.1c/openssl",
  options => "--prefix=/home/cc/ee147/fl21/class/ee147-aaf/software/openssl-1.1.1c/openssl --openssldir=/home/cc/ee147/fl21/class/ee147-aaf/software/openssl-1.1.1c/openssl enable-shared enable-zlib no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib-dynamic",
  perl_archname => "x86_64-linux-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.16.3",
  perlargv => [ "linux-x86_64", "--prefix=/home/cc/ee147/fl21/class/ee147-aaf/software/openssl-1.1.1c/openssl", "--openssldir=/home/cc/ee147/fl21/class/ee147-aaf/software/openssl-1.1.1c/openssl", "shared", "zlib" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  prefix => "/home/cc/ee147/fl21/class/ee147-aaf/software/openssl-1.1.1c/openssl",
  processor => "",
